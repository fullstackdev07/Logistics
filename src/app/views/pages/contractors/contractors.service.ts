...
export class ContractorsService {
  ...
  public getAllContractors(data : any = {}): Observable<any> {
		return this.http.get(`${environment.apiUrl}getContractorList`, data);
  }
  ...
  public deleteContractor(data : any ): Observable<any> {
		return this.http.get(`${environment.apiUrl}deleteContractor`, {params:data});
  }
