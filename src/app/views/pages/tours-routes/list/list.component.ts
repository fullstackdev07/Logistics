...
export class ListComponent implements OnInit {
  ...
  public dataTableCall(){
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
          ...
          this.tourService.getTourList(dataTablesParameters).subscribe(resp => {
            this.response = resp;
  ...
  public getTourList_old() {	
    
    
    

		this.tourService.getTourList({}).subscribe((result) => {					
  ...
  addNewTour() {
		this.router.navigate(['tours-routes/addedit']);
		// this.dialog.open(DialogDataExampleDialog);
  }

  editTour(id) {
		this.router.navigate(['tours-routes/addedit/'+id]);
		// this.dialog.open(DialogDataExampleDialog);
  }
  ...
  deleteTour(tourId : any){
    ...
    this.tourService.deleteTour({ toursId : tourId }).subscribe((result) => {	
      this.datatableElement.dtInstance.then((dtInstance: DataTables.Api) => {
        dtInstance.draw();
      });
      // this.getTourList();
